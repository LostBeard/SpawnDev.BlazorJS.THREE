...
namespace SpawnDev.BlazorJS.THREE
{
    public class ReferenceNode<T> : Node
    {
        #region Constructors
        /// <inheritdoc/>
        public ReferenceNode(IJSInProcessObjectReference _ref) : base(_ref) { }
        
        /// <summary>
        /// constructor(property: string, uniformType: string, object?: T | null, count?: number | null);
        /// </summary>
        public ReferenceNode(string property, string uniformType, T obj, float count) : base(JS.New("THREE.ReferenceNode", property, uniformType, obj, count)) { }

...
{
    /// <summary>
    /// Optional init parameters for WebGLRenderer
    ...
    public class WebGLRendererParameters
    {
        ...
        public Union<HTMLCanvasElement, OffscreenCanvas>? Canvas { get; set; }
        ...
        /// <summary>
        /// Whether to use a reverse depth buffer. Requires the EXT_clip_control extension. This is a more faster and accurate version than logarithmic depth buffer. Default is false.
        /// </summary>
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
        public bool? ReverseDepthBuffer { get; set; }
    }
}

...
{
    public partial class VRDemo : IDisposable
    {
        [Inject]
        ...
        protected override void OnAfterRender(bool firstRender)
        {
            if (canvas == null)
            {
                ...
                cube = new THREE.Mesh<BoxGeometry, MeshBasicMaterial[]>(new BoxGeometry(), materials);
                ...
                AnimateCallback = new FuncCallback<float, XRFrame?, Task>(Animate);
        ...
        async Task Animate(float time, XRFrame? frame)
        {
        ...
        async Task _Animate(float time, XRFrame? frame)
        {
